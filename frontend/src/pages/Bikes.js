...
const Bikes = () => {
    ...
    const orderHandler = async (amount) => {
        try {
            ...
            // Create an order
            const createOrderResponse = await axios.post("http://localhost:8000/api/v1/create-order", { amount });
    ...
    return (
        <div className="relative min-h-screen bg-gray-900 flex flex-col items-center">
            ...
            <div className="mt-10 w-full h-full p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 place-items-center">
